1) This scenario is to automate on the front end: Confirm an order cannot be placed when the consumer is not in the same City / Region
...
- To view screenshots --> JustEatTakeaway/screenshots/errorScreenshot.png

8) Static data (User Address) is stored in file --> JustEatTakeaway/TestData/AdressInfo.xlsx
9) To run test as headless : JustEatTakeaway/config/config.properties --> set headless=true